...
Once connected, CloudMaSa scans your AWS account to list all existing resources.

### Terraform Deployments

- **No Terraform deployments yet?**  
  Click **Create New Resource** to start building your first infrastructure.
